...
import static com.like4u.AIM.ui.config.Config.USER_HEAD_PATH;
...
public class ElementUser {
    ...
    public ElementUser(String userId, String userNickName, String userHead){
        // 用户底板(存储用户ID)
        pane = new Pane();
        pane.setId(userId);
        ...
        headLabel.setStyle(String.format(USER_HEAD_PATH, userHead));
