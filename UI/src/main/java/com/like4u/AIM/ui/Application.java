...
public class Application extends javafx.application.Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        // 模拟测试
        chat.addTalkBox(-1, 0, "1000004", "张三", "04_50", null, null, false);
        ...
        chat.addTalkBox(-1, 0, "1000002", "李四", "03_50", "秋风扫过树叶落，哪有棋盘哪有我", new Date(), false);
        ...
        // 群组
        chat.addFriendGroup("5307397", "学术交流群", "group_1");
        chat.addFriendGroup("5307392", "CSDN 社区专家", "group_2");
        chat.addFriendGroup("5307399", "洗脚城VIP", "group_3");

        // 群组 - 对话框
        chat.addTalkBox(0, 1, "5307397", "学术交流群", "group_1", "", new Date(), true);
        ...
        chat.addTalkMsgGroupLeft("5307397", "1000002", "李四", "01_50", "推我过忘川", 0, new Date(), true, false, true);
        chat.addTalkMsgGroupLeft("5307397", "1000003", "王五", "03_50", "奈河桥边的姑娘", 0, new Date(), true, false, true);
        chat.addTalkMsgGroupLeft("5307397", "1000004", "张三", "04_50", "等我回头看", 0, new Date(), true, false, true);
        chat.addTalkMsgGroupLeft("5307397", "1000004", "张三", "04_50", "f_25", 1, new Date(), true, false, true);

        // 好友
        chat.addFriendUser(false, "1000004", "张三", "04_50");
        chat.addFriendUser(false, "1000001", "李四", "02_50");
        chat.addFriendUser(false, "1000002", "王五", "03_50");
        chat.addFriendUser(true, "1000003", "赵六", "01_50");
